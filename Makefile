...
# Set optimization flags for gcc
CC_FLAGS := -Ofast -fmodulo-sched -fmodulo-sched-allow-regmoves \
...
LD_FLAGS := -Ofast --sort-common --strip-debug
...
LD		= $(CROSS_COMPILE)ld.bfd $(LD_FLAGS)
endif
